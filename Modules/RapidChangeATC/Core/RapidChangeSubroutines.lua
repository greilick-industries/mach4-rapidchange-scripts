...
function RapidChangeSubroutines.UpdateSettings()
  ...
  zStartLoad = rcSettings.GetValue(k.Z_START_LOAD)
  ...
  useMasterTool = rcSettings.GetValue(k.USE_MASTER_TOOL)
  masterTool = rcSettings.GetValue(k.MASTER_TOOL)
...
function RapidChangeSubroutines.LoadToolAuto()
  ...
  rcCntl.LinearToMachCoord_Z(zStartLoad, engageFeed)
